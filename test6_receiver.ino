...
const char* WIFI_SSID = "xử lý ảnh khó quá";
const char* WIFI_PASSWORD = "thinh12512";
...
myLoRa.println("AT+ADDR=2"); // Đặt địa chỉ LoRa module
...
myLoRa.println("AT+BAND=915000000"); // Đặt tần số hoạt động là 915MHz
  ...
  setData("LED_STATUS", "false") ;
  setData("PHUN_SUONG", "false") ;
  setData("QUAT", "false") ;
  setData("DEN", "false") ;
  setData("PHUN_NUOC", "false") ;
  setData("AUTO", "false") ;
